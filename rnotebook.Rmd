...
happiness_1 = inner_join(happiness_2015, happiness_2016, by="Country")
happiness_2 = inner_join(happiness_1, happiness_2017, by="Country")
happiness_3 = inner_join(happiness_2, happiness_2018, by="Country")
happiness = inner_join(happiness_3, happiness_2019, by="Country")
names(happiness)
```
